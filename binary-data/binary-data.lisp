...
(defpackage :net.atmosia.binary-data
  (:use :common-lisp :net.atmosia.macro-utilities)
...
(defgeneric write-value (type stream value &key)
  (:documentation "Write a value as the given type from the stream."))

(defgeneric write-object (object stream)
  (:method-combination progn :most-specific-last)
  (:documentation "Write out the slots of an object to the stream"))
     ...
     (with-gensyms (type)
       `(progn
          ...
          ,(destructuring-bind ((out value) &body body)
             ...
             `(defmethod write-value ((,type (eql ',name)) ,out ,value
                                                           &key ,@args)
                ,@body)))))))
